...
class ImportacaoTabelaDePrecoResultado extends Equatable {
  final int totalRecebidos;
  final int importados;

  const ImportacaoTabelaDePrecoResultado({
    required this.totalRecebidos,
    required this.importados,
  });

  factory ImportacaoTabelaDePrecoResultado.fromJson(
    Map<String, dynamic> json,
  ) {
    return ImportacaoTabelaDePrecoResultado(
...
class ImportacaoTabelaDePreco extends Equatable {
  final int id;
  ...
  final String? erro;
  final ImportacaoTabelaDePrecoResultado? resultado;

  const ImportacaoTabelaDePreco({
    required this.id,
  ...
  factory ImportacaoTabelaDePreco.fromJson(Map<String, dynamic> json) {
    final resultado = json['resultado'] as Map<String, dynamic>?;
    return ImportacaoTabelaDePreco(
      ...
      resultado: resultado == null
          ? null
          : ImportacaoTabelaDePrecoResultado.fromJson(resultado),
    );
  }
