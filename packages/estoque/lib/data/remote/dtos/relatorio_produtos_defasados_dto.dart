...
class RelatorioProdutoDefasadoItemDto implements RelatorioProdutoDefasadoItem {
  ...
  @override final int quantidadeProdutos;
  @override final int saldo;
  @override final double valorUnitario;
  @override final double valorTotal;
  @override final String? ultimaEntrada;
  @override final String? ultimaSaida;
  @override final int? diasSemMovimentacao;
...
class RelatorioProdutosDefasadosMetaDto
  ...
  factory RelatorioProdutosDefasadosMetaDto.fromJson(
...
class RelatorioProdutosDefasadosResumoDto
  ...
  @override final int quantidadeDefasados;
  @override final int totalEmEstoque;
  @override final double percentualDefasado;
  @override final double valorTotalDefasado;
...
class RelatorioProdutosDefasadosDto implements RelatorioProdutosDefasados {
  @override final List<RelatorioProdutoDefasadoItem> items;
  @override final RelatorioProdutosDefasadosMeta meta;
  @override final RelatorioProdutosDefasadosResumo resumo;
  ...
  factory RelatorioProdutosDefasadosDto.fromJson(Map<String, dynamic> j) =>
      RelatorioProdutosDefasadosDto(
        items: (j['items'] as List<dynamic>? ?? [])
            .map((e) => RelatorioProdutoDefasadoItemDto.fromJson(
