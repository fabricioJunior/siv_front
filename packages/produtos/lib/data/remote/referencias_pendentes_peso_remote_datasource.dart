...
class ReferenciasPendentesPesoRemoteDatasource extends RemoteDataSourceBase
    implements IReferenciasPendentesPesoRemoteDataSource {
  ReferenciasPendentesPesoRemoteDatasource({
  ...
  Future<ReferenciasSemPesoResultado> fetchReferenciasSemPeso({
    ...
    final response = await get(
      pathParameters: {'segmento': 'sem-dados-logisticos'},
      queryParameters: {
    ...
    return ReferenciasSemPesoResultado(
      items: rawItems
  ...
  Future<AtualizarDadosLogisticosEmMassaResultado>
      atualizarDadosLogisticosEmMassa() async {
    final response = await patch(
      pathParameters: {'segmento': 'atualizar-dados-logisticos-em-massa'},
      body: {},
    );

    final body = response.body as Map<String, dynamic>;
    return AtualizarDadosLogisticosEmMassaResultado(
